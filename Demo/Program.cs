...
internal static class Demo
{
    ...
    public static int FirstIndexOfNumber(ReadOnlySpan<char> value)      => value.IndexOfAny(s_firstIndexOfNumberInitData);
    public static int FirstIndexOfSet0(ReadOnlySpan<char> value)        => value.IndexOfAny(s_firstIndexOfSet0);
    //public static int FirstIndexOfNonAsciiSet(ReadOnlySpan<char> value) => value.IndexOfAny(s_firstIndexOfNonAsciiSet);
    ...
    public static int FirstIndexOfNotSet0(ReadOnlySpan<char> value) => value.IndexOfAnyExcept(s_firstIndexOfNotSet0);
    public static int FirstIndexOfNotSet1(ReadOnlySpan<char> value) => value.IndexOfAnyExcept(s_firstIndexOfNotSet1);
}
