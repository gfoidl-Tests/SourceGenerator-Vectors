...
{
    [TestFixture]
    public class IndexOfInvalidTokenCharTests
    {
        [Test]
        public void Scalar()
        {
            for (int i = char.MinValue; i <= char.MaxValue; ++i)
            {
                ...
                int idx0 = HttpCharacters.IndexOfInvalidTokenChar(s);
                int idx1 = HttpCharacters_Vectorized.IndexOfInvalidTokenChar(s);
