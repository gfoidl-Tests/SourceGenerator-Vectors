...
{
    [TestFixture]
    public class IndexOfInvalidFieldValueCharExtendedTests
    {
        [Test]
        public void Scalar()
        {
            for (int i = char.MinValue; i <= char.MaxValue; ++i)
            {
                ...
                int idx0 = HttpCharacters.IndexOfInvalidFieldValueCharExtended(s);
                int idx1 = HttpCharacters_Vectorized.IndexOfInvalidFieldValueCharExtended(s);
